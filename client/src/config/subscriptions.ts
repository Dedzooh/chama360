...
export const SUBSCRIPTION_PLANS = [
  ...
  { id: 'STARTER' as const, name: 'Starter', monthlyPrice: 399, annualPrice: 3990, memberLimit: 50, description: 'For growing groups that need professional records and secure documents.', features: ['Up to 50 members', 'Everything in Community', 'Professional PDF and CSV exports', 'Documents and verification'] },

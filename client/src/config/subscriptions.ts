...
export const SUBSCRIPTION_PLANS = [
  ...
  { id: 'STARTER' as const, name: 'Starter', monthlyPrice: 150, annualPrice: 1500, memberLimit: 30, storage: { label: '1 GB', megabytes: 1024 }, description: 'Professional Chama records and a complete monthly meeting pack.', features: ['Up to 30 members', 'Everything in Community', 'Member statements and contribution reports', 'Loan, welfare and arrears reports', 'Documents, receipts and CSV/Excel exports'] },
  { id: 'STANDARD' as const, name: 'Standard', monthlyPrice: 350, annualPrice: 3500, memberLimit: 50, storage: { label: '5 GB', megabytes: 5120 }, description: 'Governance and accountability for established Chamas.', popular: true, features: ['Up to 50 members', 'Everything in Starter', 'Digital voting and complete audit trail', 'Approval workflows and multi-approval welfare', 'Treasurer, Chairperson and Secretary controls', 'Financial exception centre and reminders'] },
  { id: 'GROWTH' as const, name: 'Growth', monthlyPrice: 500, annualPrice: 5000, memberLimit: 100, storage: { label: '5 GB', megabytes: 5120 }, description: 'Advanced governance for larger Chamas.', popular: false, features: ['Up to 100 members', 'Everything in Standard', 'Expanded controls and strategic planning tools', 'Advanced financial oversight and reporting'] },

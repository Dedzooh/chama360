...
export const SUBSCRIPTION_PLANS = [
  ...
  { id: 'GROWTH' as const, name: 'Standard', monthlyPrice: 350, annualPrice: 3500, memberLimit: 50, storage: { label: '5 GB', megabytes: 5120 }, description: 'Governance and accountability for established Chamas.', popular: true, features: ['Up to 50 members', 'Everything in Starter', 'Digital voting and complete audit trail', 'Approval workflows and multi-approval welfare', 'Treasurer, Chairperson and Secretary controls', 'Financial exception centre and reminders'] },

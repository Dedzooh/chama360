...
export const Help = () => (
  <div className="space-y-6">
    <section className="chama360-module-hero"><div className="chama360-module-hero-main"><div className="chama360-module-hero-copy"><p>Help centre</p><h1>Support when you need it</h1><small>Guidance for accounts, organizations, payments, reports, and the CHAMAZ360 mobile app.</small></div></div></section>
    <div className="grid gap-4 md:grid-cols-3">
      <Card className="p-5"><LifeBuoy className="h-6 w-6 text-[var(--ds-primary)]"/><h2 className="mt-3 font-black text-[var(--ds-secondary)]">Using CHAMAZ360</h2><p className="mt-2 text-sm text-[var(--ds-text-muted)]">Start from My Chamas, select an organization, then use its dashboard to manage members, contributions, loans, welfare, meetings, and reports.</p></Card>

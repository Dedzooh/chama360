...
export const Legal = () => (
  <PublicPageFrame
    ...
    title="Clear rules for using CHAMAZ360"
  ...
  >
      <div className="space-y-5">
        <section id="terms" className="section-shell p-6 sm:p-8"><h2 className="text-2xl font-black text-[var(--ds-secondary)]">Terms of Service</h2><div className="mt-4 space-y-4 text-sm leading-7 text-[var(--ds-text-muted)]">
          <p>CHAMAZ360 provides record-keeping, communication, governance, reporting, and payment-support tools for Chamas and other organizations. It does not promise investment returns, replace professional financial or legal advice, or hold itself out as a bank.</p>
        ...
        <section id="billing" className="section-shell p-6 sm:p-8"><h2 className="text-2xl font-black text-[var(--ds-secondary)]">Subscriptions, cancellation and refunds</h2><div className="mt-4 space-y-4 text-sm leading-7 text-[var(--ds-text-muted)]">
          <p>Paid plans apply to the selected organization for the displayed billing period. The amount and organization are shown before an M-Pesa request is sent. CHAMAZ360 never asks for or stores an M-Pesa PIN.</p>

...
export const subscriptionPlans = {
  ...
  STANDARD: { name: 'Standard', monthlyPrice: 350, annualPrice: 3500, memberLimit: 50, storageLimitMb: 5120, trialDays: 14, features: ['CORE', 'ADVANCED_EXPORTS', 'DOCUMENTS', 'VOTING', 'AUDIT_LOGS', 'ADMIN_CONTROLS'] },
  GROWTH: { name: 'Growth', monthlyPrice: 500, annualPrice: 5000, memberLimit: 100, storageLimitMb: 5120, trialDays: 14, features: ['CORE', 'ADVANCED_EXPORTS', 'DOCUMENTS', 'VOTING', 'AUDIT_LOGS', 'ADMIN_CONTROLS'] },

...
export const subscriptionPlans = {
  ...
  GROWTH: { name: 'Growth', monthlyPrice: 350, annualPrice: 3500, memberLimit: 50, storageLimitMb: 5120, trialDays: 14, features: ['CORE', 'ADVANCED_EXPORTS', 'DOCUMENTS', 'VOTING', 'AUDIT_LOGS', 'ADMIN_CONTROLS'] },

...
requireCheck('Business identity', present('BILLING_BUSINESS_NAME', 'BILLING_BUSINESS_ADDRESS', 'BILLING_TAX_PIN') && env.BILLING_BUSINESS_NAME !== 'CHAMAZ360' && env.BILLING_BUSINESS_ADDRESS !== 'Nairobi, Kenya', 'Registered billing identity is configured.', 'Add the registered business name, complete address and tax PIN.');
